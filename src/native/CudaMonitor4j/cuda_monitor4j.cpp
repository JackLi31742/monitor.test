 ...
 * Signature: (I)I
 */
JNIEXPORT jint JNICALL Java_org_cripac_isee_vpe_ctrl_MonitorThread_getPid
 ...
 * Signature: (I)J
 */
JNIEXPORT jlong JNICALL Java_org_cripac_isee_vpe_ctrl_MonitorThread_getUsedGpuMemory
  (JNIEnv *env, jobject obj, jint index, jint num){
unsigned int infoCount;
nvmlProcessInfo_t infos[10];
nvmlDeviceGetComputeRunningProcesses(getDevice((unsigned int) index),&infoCount,infos);
